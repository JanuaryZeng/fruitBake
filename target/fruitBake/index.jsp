...
<div class="account-pages">
    <div class="wrapper-page">
        <div class="text-center">
            <a href="index.html" class="logo"><span>水果<span>烘焙房</span></span></a>
        </div>
            ...
            <div class="panel-body">
                <form class="am-form">
                    <div class="am-g">
                        ...
                        <div class="am-form-group ">
                            <a href="/fruitBake_war_exploded/hardware/home" type="button" class="am-btn am-btn-primary am-radius" style="width: 100%;height: 100%;">登 陆</a>
                        </div>
                    </div>
